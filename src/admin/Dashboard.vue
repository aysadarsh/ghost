      ...
      <div class="card">
        <div class="card-body">
          <div class="sm:flex block justify-between mb-5">
            <h4 class="text-gray-600 text-lg font-semibold sm:mb-0 mb-2">Overview</h4>
            <select
              name="cars"
              id="cars"
        ...
        <ul class="timeline-widget relative">
          ...
          <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
            ...
            <div class="timeline-desc py-[6px] px-4 text-sm">
              ...
              <a href="#" class="text-blue-600">#ML-3467</a>
            </div>
          </li>
            ...
            <table class="text-left w-full whitespace-nowrap text-sm">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="p-4">
                    <span
                      class="inline-flex items-center py-[3px] px-[10px] rounded-2xl font-semibold text-white bg-red-500"
                      >High</span
                    >
                  </td>
                  <td class="p-4">
