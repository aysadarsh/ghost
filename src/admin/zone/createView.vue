...
const handleSubmit = async (e: Event) => {
  try {
    ...
    const get = await HandleApi(`brandZone/create`, {
      method: 'POST',
    ...
    if (pass(get)) {
      Swal.fire({
        title: 'Success!',
        text: 'Brand zone created successfully',
        icon: 'success'
      })
        ...
        <div className="card h-full">
          <div className="card-body">
            <div class="flex justify-between">
              <div>
                <h4 className="text-gray-600 text-lg font-semibold mb-6">Create Brand Zone</h4>
              </div>
              <div v-if="isModal">
